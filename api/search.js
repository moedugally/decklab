...
- "attack that reduces damage taken next turn" / "attack that makes this pokemon take less damage" / "defensive attack damage reduction" / "attacks that say this pokemon takes less damage" / "pokemon with attacks that modify your opponent's pokemon's damage output" / "attack with temporary damage shield" → cardTextContains: ["takes 10 less damage from attacks", "takes 20 less damage from attacks", "takes 30 less damage from attacks", "takes 40 less damage from attacks", "takes 50 less damage from attacks", "Defending Pokémon takes 10 less", "Defending Pokémon takes 20 less", "Defending Pokémon takes 30 less", "during your opponent's next turn, this Pokémon takes", "this Pokémon takes 10 less damage", "this Pokémon takes 20 less damage", "this Pokémon takes 30 less damage"]
...
export default async function handler(req, res) {
  ...
  const cacheKey = `v58:search:standard:${typeFilter.toLowerCase()}:${query.trim().toLowerCase()}`;
