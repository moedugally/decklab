...
- "pokemon that do damage based on damage counters on opponent" / "damage scales with opponent's damage counters" / "more damage based on existing damage counters on your opponents pokemon" / "damage multiplied by opponent's counters" → cardTextContains: ["more damage for each damage counter on your opponent's Active", "damage for each damage counter on your opponent's Active", "damage for each damage counter on the Defending", "for each damage counter on your opponent's Active", "for each damage counter on the Defending", "damage for each damage counter on that Pokémon", "for each damage counter on that Pokémon", "10 more damage for each damage counter on your opponent", "20 more damage for each damage counter on your opponent", "30 more damage for each damage counter on your opponent", "50 more damage for each damage counter on your opponent", "has any damage counters on it"]
- "pokemon that do damage based on their own damage counters" / "damage scales with own damage counters" / "more damage the more damaged this pokemon is" / "damage based on damage counters on this pokemon" → cardTextContains: ["damage for each damage counter on this Pokémon", "more damage for each damage counter on this Pokémon", "10 more damage for each damage counter on this", "20 more damage for each damage counter on this", "30 more damage for each damage counter on this", "for each damage counter on this Pokémon"]
...
export default async function handler(req, res) {
  ...
  const cacheKey = `v65:search:standard:${typeFilter.toLowerCase()}:${query.trim().toLowerCase()}`;
