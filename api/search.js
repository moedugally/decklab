...
- "pokemon that do damage based on damage counters on opponent" / "damage scales with opponent's damage counters" / "more damage based on existing damage counters on your opponents pokemon" / "damage multiplied by opponent's counters" → cardTextContains: ["for each damage counter on your opponent's Active", "for each damage counter on the Defending", "damage counter on your opponent's Active", "damage counter on the Defending Pokémon", "damage counters on your opponent's Active", "for each damage counter on that Pokémon"]. ONLY use phrases that reference "your opponent's" or "the Defending" or "that Pokémon" (the target). Do NOT include phrases with "this Pokémon", "your Pokémon", or "your Active Pokémon" — those refer to the user's own pokemon, not the opponent's.
- "pokemon that do damage based on their own damage counters" / "damage scales with own damage counters" / "more damage the more damaged this pokemon is" / "damage based on damage counters on this pokemon" / "damage based on how injured this pokemon is" → cardTextContains: ["for each damage counter on this Pokémon", "damage counter on this Pokémon", "damage counters on this Pokémon", "for each damage counter on your Active Pokémon", "for each damage counter on your Pokémon"]. Only use phrases referencing "this Pokémon", "your Pokémon", or "your Active Pokémon".
- "pokemon that hit all pokemon with damage counters" / "damage to all pokemon that are already damaged" / "spread damage to injured pokemon" / "attack that hits all damaged pokemon" → cardTextContains: ["damage counters on it (both yours and your opponent's", "damage to each Pokémon that has any damage counters"]
- "place damage counters" / "pokemon that place damage counters" / "put damage counters on opponent" / "damage counter placement" / "spread damage counters" / "place counters on benched" → cardTextContains: ["place 1 damage counter", "place 2 damage counters", "place 3 damage counters", "place 4 damage counters", "place 5 damage counters", "place 6 damage counters", "place 7 damage counters", "place 8 damage counters", "place 10 damage counters", "place 12 damage counters", "place damage counters on", "put 1 damage counter", "put 2 damage counters", "put 3 damage counters", "put 4 damage counters", "put 5 damage counters", "put 6 damage counters", "put damage counters on", "damage counters on each of your opponent's"]
...
- "ability that boosts active damage" / "modify active pokemon's damage" / "damage boost from bench" / "abilities that increase damage output" / "bench pokemon that buff active" / "abilities that modify your active pokemon's damage" / "abilities that can modify your active pokemon's damage" / "pokemon that boost damage of active" / "pokemon with abilities that boost your active pokemon's damage" → requireAbility: true, abilityTextContains: ["do 10 more damage to your opponent's Active", "do 20 more damage to your opponent's Active", "do 30 more damage to your opponent's Active", "do 40 more damage to your opponent's Active", "do 50 more damage to your opponent's Active", "do 60 more damage to your opponent's Active", "does 10 more damage to your opponent's Active", "does 20 more damage to your opponent's Active", "does 30 more damage to your opponent's Active", "does 40 more damage to your opponent's Active", "does 50 more damage to your opponent's Active", "your Active Pokémon's attacks do", "your Pokémon's attacks do", "Active Pokémon's attacks do 10 more", "Active Pokémon's attacks do 20 more", "Active Pokémon's attacks do 30 more"]. Do NOT set cardTextContains for this query type — use abilityTextContains only.
- "ability that reduces opponent damage" / "ability that reduces damage taken by opponent's active" / "debuff opponent damage output" → requireAbility: true, abilityTextContains: ["attacks used by your opponent's Active Pokémon do 10 less", "attacks used by your opponent's Active Pokémon do 20 less", "attacks used by your opponent's Active Pokémon do 30 less", "attacks used by your opponent's Pokémon do 10 less", "attacks used by your opponent's Pokémon do 20 less", "attacks used by your opponent's Pokémon do 30 less"]
- "attack that reduces damage taken next turn" / "attack that makes this pokemon take less damage" / "defensive attack damage reduction" / "attacks that say this pokemon takes less damage" / "attack with temporary damage shield" → cardTextContains: ["takes 10 less damage from attacks", "takes 20 less damage from attacks", "takes 30 less damage from attacks", "takes 40 less damage from attacks", "takes 50 less damage from attacks", "Defending Pokémon takes 10 less", "Defending Pokémon takes 20 less", "Defending Pokémon takes 30 less", "during your opponent's next turn, this Pokémon takes", "this Pokémon takes 10 less damage", "this Pokémon takes 20 less damage", "this Pokémon takes 30 less damage"]
- "modify opponent's damage output" / "reduce opponent's damage output" / "debuff opponent damage" / "pokemon with attacks that modify your opponent's pokemon's damage output" / "pokemon that reduce how much damage opponent does" → cardTextContains: ["takes 10 less damage from attacks", "takes 20 less damage from attacks", "takes 30 less damage from attacks", "takes 40 less damage from attacks", "takes 50 less damage from attacks", "Defending Pokémon takes 10 less", "Defending Pokémon takes 20 less", "Defending Pokémon takes 30 less", "during your opponent's next turn, this Pokémon takes", "this Pokémon takes 10 less damage", "this Pokémon takes 20 less damage", "this Pokémon takes 30 less damage", "attacks used by your opponent's Active Pokémon do 10 less", "attacks used by your opponent's Active Pokémon do 20 less", "attacks used by your opponent's Active Pokémon do 30 less", "attacks used by your opponent's Pokémon do 10 less", "attacks used by your opponent's Pokémon do 20 less", "attacks used by your opponent's Pokémon do 30 less"]
- "ability that reduces damage taken" / "ability that prevents damage to active" / "damage reduction ability" / "reduce damage to my pokemon" → requireAbility: true, abilityTextContains: ["damage done to this Pokémon is reduced", "damage dealt to this Pokémon is reduced", "attacks do 10 less damage", "attacks do 20 less damage", "attacks do 30 less damage", "takes 10 less damage", "takes 20 less damage", "takes 30 less damage"]
...
export default async function handler(req, res) {
  ...
  const cacheKey = `v67:search:standard:${typeFilter.toLowerCase()}:${query.trim().toLowerCase()}`;
  ...
  try {
    ...
    if (cachedCandidates) {
      ...
      if (vectorCards.length > 0) cacheSet(cacheKey, vectorCards);
    }
