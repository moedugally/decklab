...
- "ability that boosts active damage" / "modify active pokemon's damage" / "damage boost from bench" / "abilities that increase damage output" / "bench pokemon that buff active" / "abilities that modify your active pokemon's damage" / "pokemon that boost damage of active" → requireAbility: true, abilityTextContains: ["attacks used by your", "do 10 more damage to your opponent's Active", "do 20 more damage to your opponent's Active", "do 30 more damage to your opponent's Active", "do 40 more damage to your opponent's Active", "do 50 more damage to your opponent's Active", "do 60 more damage to your opponent's Active", "does 10 more damage to your opponent's Active", "does 20 more damage to your opponent's Active", "does 30 more damage to your opponent's Active", "does 40 more damage to your opponent's Active", "does 50 more damage to your opponent's Active", "your Active Pokémon's attacks do", "Active Pokémon's attacks do 10 more", "Active Pokémon's attacks do 20 more", "Active Pokémon's attacks do 30 more"]. Do NOT set cardTextContains for this query type — use abilityTextContains only.
...
export default async function handler(req, res) {
  ...
  const cacheKey = `v59:search:standard:${typeFilter.toLowerCase()}:${query.trim().toLowerCase()}`;
